...
export async function drawProjectCard(data) {
  ...
  ctx.fillText('Generated by Koishi | Powered by Modrinth & CurseForge | Plugin By yabo083 & Mai_xiyu', width / 2, footerY);
  footerY += 18;
  
  // 3. 绘制要求的作者署名
  ctx.fillText('Plugin By yabo083 & Mai_xiyu', width / 2, footerY);
