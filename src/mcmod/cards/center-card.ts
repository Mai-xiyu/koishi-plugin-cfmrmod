...
// ================= 普通用户卡片 (Center Card) =================
export async function drawCenterCard(uid, logger) { return drawCenterCardImpl(uid, logger); }
export async function drawCenterCardImpl(uid, logger) {
    ...
    ctx.fillText('mcmod.cn & bbs.mcmod.cn | Powered by Koishi | Plugin By Mai-xiyu', width / 2, totalHeight - 15);
